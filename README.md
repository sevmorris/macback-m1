...
My methods of configuring, deploying and redeploying macOS on an M1 Mac.<br>
(See [intel branch](https://github.com/sevmorris/macback/tree/intel) for Intel Mac's)
